...
#hyperparameters
batch_size = 32      # number of samples to process in parallel
...
class BigramLanguage_model(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        logits = self.token_embedding(idx) # [batch_size, block_size, vocab_size] (B,T,C)
...
model = BigramLanguage_model(vocab_size).to(device)
